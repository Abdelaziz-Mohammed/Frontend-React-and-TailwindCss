...
function Header() {
  ...
  function handleNavigate(link) {
    if (link === 'Features') {
      window.scrollTo({
        top: document.getElementById('features').offsetTop - 120,
        behavior: 'smooth',
      });
    }
    else if (link === 'Team') {
      window.scrollTo({
        top: document.getElementById('testimonials').offsetTop - 120,
        behavior: 'smooth',
      });
    }
    else { // 'SignIn
      window.scrollTo({
        top: document.getElementById('get-started').offsetTop - 120,
        behavior: 'smooth',
      });
    }
  }
